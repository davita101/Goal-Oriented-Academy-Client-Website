...
const SheetOverlay = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SheetPrimitive.Overlay, Object.assign({ className: cn("fixed inset-0 z-50 data-[state=open]:animate-in data-[state=open]:bg-black/10 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className) }, props, { ref: ref })));
});
...
const SheetContent = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SheetPortal, null,
        ...
        React.createElement(SheetPrimitive.Content, Object.assign({ ref: ref, className: cn(sheetVariants({ side }), className) }, props), children)));
});
