...
var UserProvider = function (_a) {
        ...
        var checkAuth = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("http://localhost:5000/api/auth/check-auth", {
                                method: 'GET',
                                credentials: 'include'
                            })];
                    case 1:
    ...
    return (react_1.default.createElement(UserContext.Provider, { value: { currentUser: currentUser, setCurrentUser: setCurrentUser } }, children));
};
